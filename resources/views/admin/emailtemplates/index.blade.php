...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="{{ url('/admin/dashboard/') }}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">Email Template Listing</a> </div>
    <h1>Email Template Listing</h1>
  ...
  <div class="container-fluid"><hr>
    <div class="row-fluid">  <form  class="form-horizontal"  enctype="multipart/form-data" method="post" action="{{ url('admin/emailtemplates') }}" name="index" id="memberindex" novalidate="novalidate"> 
        <div class="span12">
			  ...
			  @foreach($emailtemp as $data)
				...
				<input type="checkbox" value="{{ $data['id'] }}" class="checkbox_align select-checkbox" name="box1[]"  >
				 ...
				 <td class="center">
											    ...
											    <a type="button" class="btn btn-success btn-mini" title="Edit" href="{{ url('/admin/emailtemplates/edit/'.$data['id']) }}"><i class="fa icon-edit"></i></a>
									 ...
									 <div id="myModal{{ $data['id'] }}" class="modal hide">
									  <div class="modal-header">
										...
										<h3>{{ $data['title'] }} Full Details</h3>
									  </div>
									  <div class="modal-body">
										<p>Email Template ID: {{ $data['id'] }}</p>
