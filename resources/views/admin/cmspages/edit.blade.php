...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="{{ url('/admin/dashboard/') }}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="{{ url('/admin/cmspages') }}">Cms Pages</a> <a href="#" class="current">Edit Cms Page</a> </div>
    <h1>Cms Pages</h1>
      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{{ url('admin/cmspages/update/'.$tempDetails->id) }}" name="add_user" id="add_user" novalidate="novalidate">{{ csrf_field() }}
  </br>
            ...
            <h5> Details</h5>
              ...
              <div class="control-group">
			   ...
			   <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="slug" id="slug" placeholder="Title" value="{{ $tempDetails->slug }}" style="width:500px;">
				  @if ($errors->has('slug'))
			  ...
			  <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="page_name" id="page_name" placeholder="Subject" value="{{ $tempDetails->page_name }}" style="width:500px;">
               ...
               <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="keywords" id="keywords" placeholder="Subject" value="{{ $tempDetails->keywords }}" style="width:500px;">
